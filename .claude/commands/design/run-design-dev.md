...
- `--screenflow`: Request screen flow analysis with Dashboard Wireframe (SVG) as primary method (OPTIONAL)
  ...
  - **DOCUMENTATION**: References enhanced `.claude/docs/design/screenflows-storyboarding.md` and `.claude/docs/design/screenflows-wireframes.md`
...
- `--wireframes`: Update wireframes documentation with embedded image examples (OPTIONAL)
  ...
  - **TARGET**: Updates `.claude/docs/design/screenflows-wireframes.md` with embedded image examples
...
- **v1.6.0** - Updated screenflow flag and agent integration
  ...
  - Added documentation references: `.claude/docs/design/screenflows-storyboarding.md` and `.claude/docs/design/screenflows-wireframes.md`
...
- **v1.3.0** - Meta-command compliance update
  - Updated to follow meta-command guidelines from .claude/docs/agent-complex/claude-command-file-rules.md
